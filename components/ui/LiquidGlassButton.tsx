          ...
          <svg className="absolute w-0 h-0 overflow-hidden pointer-events-none" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <filter id={filterId0} x="0" y="0" width="100%" height="100%" filterUnits="userSpaceOnUse" primitiveUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
                <feImage ref={feImage0Ref} href={undefined} x="0" y="0" width="200" height="80" result="lens" preserveAspectRatio="none" />
              ...
              <filter id={filterId1} x="0" y="0" width="100%" height="100%" filterUnits="userSpaceOnUse" primitiveUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
                <feImage ref={feImage1Ref} href={undefined} x="0" y="0" width="200" height="80" result="lens" preserveAspectRatio="none" />
                <feFlood floodColor="rgb(128,128,128)" result="neutral" />
                <feComposite in="lens" in2="neutral" operator="over" result="dispMap" />
                <feDisplacementMap in="SourceGraphic" in2="dispMap" scale={DISP_SCALE.toString()} xChannelSelector="R" yChannelSelector="G" />
              </filter>
    ...
    return (
      ...
      >
        ...
        <span
          ...
          style={{
            background: renderMode === "webgl" ? "transparent" : "rgba(255, 255, 255, 0.42)",
            backdropFilter: renderMode === "webgl" ? "none" : "blur(18px) saturate(190%) contrast(90%)",
            WebkitBackdropFilter: renderMode === "webgl" ? "none" : "blur(18px) saturate(190%) contrast(90%)",
            backgroundImage: renderMode === "webgl" ? "none" : "radial-gradient(circle at calc(50% - var(--cos) * 50%) calc(50% - var(--sin) * 50%), rgba(255,255,255,0.3) 0%, transparent 60%)",
            boxShadow: renderMode === "webgl" ? `
